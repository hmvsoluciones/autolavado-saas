...
type ProveedorComponentType = InstanceType<typeof Proveedor>;
...
describe('Component Tests', () => {
  ...
  describe('Proveedor Management Component', () => {
    ...
    let mountOptions: MountingOptions<ProveedorComponentType>['global'];
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        ...
        // WHEN
        const wrapper = shallowMount(Proveedor, { global: mountOptions });
        const comp = wrapper.vm;
        await comp.$nextTick();

        // THEN
        expect(proveedorServiceStub.retrieve.calledOnce).toBeTruthy();
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(proveedorServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      let comp: ProveedorComponentType;
      ...
      beforeEach(async () => {
        ...
        proveedorServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
