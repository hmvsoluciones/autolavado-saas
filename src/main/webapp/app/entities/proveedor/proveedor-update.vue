  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2 id="autolavadoSaasApp.proveedor.home.createOrEditLabel" data-cy="ProveedorCreateUpdateHeading">Crear o editar Proveedor</h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="proveedor-nombre">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
          ...
          <div class="form-group">
            <label class="form-control-label" for="proveedor-email">Email</label>
            <input
              type="text"
              class="form-control"
              name="email"
          ...
          <div class="form-group">
            <label class="form-control-label" for="proveedor-telefono">Telefono</label>
            <input
              type="text"
              class="form-control"
              name="telefono"
          ...
          <div class="form-group">
            <label class="form-control-label" for="proveedor-razonSocial">Razon Social</label>
            <input
              type="text"
              class="form-control"
              name="razonSocial"
              ...
              data-cy="razonSocial"
              :class="{ valid: !v$.razonSocial.$invalid, invalid: v$.razonSocial.$invalid }"
              v-model="v$.razonSocial.$model"
            />
            <div v-if="v$.razonSocial.$anyDirty && v$.razonSocial.$invalid">
              <small class="form-text text-danger" v-for="error of v$.razonSocial.$errors" :key="error.$uid">{{ error.$message }}</small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" for="proveedor-rfc">Rfc</label>
            <input
              type="text"
              class="form-control"
              name="rfc"
              id="proveedor-rfc"
              data-cy="rfc"
              :class="{ valid: !v$.rfc.$invalid, invalid: v$.rfc.$invalid }"
              v-model="v$.rfc.$model"
            />
            <div v-if="v$.rfc.$anyDirty && v$.rfc.$invalid">
              <small class="form-text text-danger" v-for="error of v$.rfc.$errors" :key="error.$uid">{{ error.$message }}</small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" for="proveedor-activo">Activo</label>
            <input
              type="checkbox"
              class="form-check"
              name="activo"
