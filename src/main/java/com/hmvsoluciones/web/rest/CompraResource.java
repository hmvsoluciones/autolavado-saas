...
import com.hmvsoluciones.service.CompraQueryService;
import com.hmvsoluciones.service.CompraService;
...
/**
 * REST controller for managing {@link com.hmvsoluciones.domain.Compra}.
 */
@RestController
...
public class CompraResource {
    ...
    public ResponseEntity<CompraDTO> createCompra(@Valid @RequestBody CompraDTO compraDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/compras/" + compraDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, compraDTO.getId().toString()))
            .body(compraDTO);
    }
