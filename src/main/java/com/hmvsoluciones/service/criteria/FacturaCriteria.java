...
/**
 * Criteria class for the {@link com.hmvsoluciones.domain.Factura} entity. This class is used
 * in {@link com.hmvsoluciones.web.rest.FacturaResource} to receive all the possible filtering options from
...
public class FacturaCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, numero, fechaEmision, total, activo, ventaId, distinct);
    }
