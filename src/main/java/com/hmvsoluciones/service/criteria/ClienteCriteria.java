...
/**
 * Criteria class for the {@link com.hmvsoluciones.domain.Cliente} entity. This class is used
 * in {@link com.hmvsoluciones.web.rest.ClienteResource} to receive all the possible filtering options from
...
public class ClienteCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nombre, email, telefono, razonSocial, rfc, activo, ventaId, distinct);
    }
